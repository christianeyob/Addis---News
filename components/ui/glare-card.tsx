...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative items-end  isolate [contain:layout_style] [perspective:100px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform ] [aspect-ratio:17/21]"
      ref={refElement}
      onPointerMove={(event) => {
