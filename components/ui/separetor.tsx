  ...
  if (label) {
    return (
      <div className="flex items-center w-full">
        ...
        ></div>
        <div className="text-black uppercase w-fit dark:text-white text-nowrap">
          {label}
        </div>
        <div
          className={cn(
  ...
  return (
    <div
      className={cn(
        'rounded-full w-full',
        gradient
          ? 'bg-gradient-to-r from-transparent via-neutral-500 dark:via-neutral-200 to-transparent dark:from-neutral-800 dark:to-neutral-700'
